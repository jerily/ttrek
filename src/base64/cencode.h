...
#ifndef TTREK_CENCODE_H
#define TTREK_CENCODE_H
...
extern size_t
base64_encode_block(const void *plaintext_in, const size_t length_in, char *code_out, base64_encodestate *state_in);
